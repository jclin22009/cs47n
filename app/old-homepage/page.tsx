...
import { Users, BookOpen, Trophy, Map } from "lucide-react";

// Course schedule data
const scheduleData = [
  {
    week: 1,
    topic: "Introductions & Data Dive-In / Whirlwind Tour",
    assignment: "Baseball Prediction Challenge",
  },
  {
    week: 2,
    topic: "Women's Soccer Coach / Spreadsheet Analysis",
    assignment: "Problem Set #1 (Soccer)",
  },
  {
    week: 3,
    topic: "Men's Basketball Coach / Tableau Desktop",
    assignment: "Problem Set #2 (Basketball)",
  },
  {
    week: 4,
    topic: "Football Coach / Tableau Prep",
    assignment: "Problem Set #3 (Football)",
  },
  {
    week: 5,
    topic: "Baseball Coach / SQL Analysis",
    assignment: "Problem Set #4 (Track)",
  },
  {
    week: 6,
    topic: "Track & Field Coach / SF Giants Game Planning",
    assignment: "Personal Project Proposals",
  },
  {
    week: 7,
    topic: "SF Giants Field Trip / Python-Pandas",
    assignment: "SF Giants Data Analysis",
  },
  {
    week: 8,
    topic: "Men's Golf Coach / Machine Learning",
    assignment: "Personal Projects",
  },
  {
    week: 9,
    topic: "Women's Gymnastics Coach / Project Presentations",
    assignment: "Project Presentations",
  },
  {
    week: 10,
    topic: "Project Presentations / Prize Ceremony",
      ...
      <div className="mb-8 border-4 border-blue-200 dark:border-blue-900 rounded-lg overflow-hidden">
        ...
        <div className="p-6 pt-2 text-center">
          <p className="text-lg mb-4">
            Spring 2025 | Tuesdays & Thursdays 1:30-2:50 PM | Sapp Center (STLC)
            105
          </p>
          <button
            ...
            onClick={() =>
              window.open(
                "https://docs.google.com/document/d/1lZia1w3vK5maRN2Gr2msON_cLzUbcJH6cBZN4x4VW1U/edit",
                "_blank"
              )
            }
          >
        ...
        {activeTab === "overview" && (
          <div className="space-y-6">
            <div className="border rounded-lg overflow-hidden">
              ...
              <div className="p-4">
                <p className="mb-4">
                  This immersive seminar combines extensive hands-on data
                  analytics with a first-hand peek into Stanford athletics.
                  Class meetings alternate between instruction in various tools
                  and techniques for data analysis and guest lectures by
                  Stanford athletics coaches.
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                  <div className="border rounded-lg p-4">
                    ...
                    <p className="text-center text-sm mt-2">
                      Master spreadsheets, Tableau, SQL, Python, and machine
                      learning techniques
                    </p>
                  </div>
                  ...
                  <div className="border rounded-lg p-4">
                    ...
                    <p className="text-center text-sm mt-2">
                      Engage with Stanford coaches from seven different sports
                      programs
                    </p>
                  </div>
            ...
            <div className="border rounded-lg overflow-hidden">
              ...
              <div className="px-4 py-3 border-t bg-gray-50 dark:bg-gray-800 text-sm text-gray-500">
                No background in statistics or data analysis needed, but basic
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="border rounded-lg overflow-hidden">
              <div className="p-4 border-b">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  Guest coaches from 7 different sports
                </p>
              </div>
            ...
            <div className="border rounded-lg overflow-hidden">
              <div className="p-4 border-b">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  Learn 6 essential data analytics tools
                </p>
              </div>
              <div className="p-4 h-72">
                <ResponsiveContainer width="100%" height="100%">
